...
\begin{questions}
    ...
    \begin{tcolorbox}[fit,height=8cm, width=\linewidth, blank, borderline={0.5pt}{-2pt},halign=center, nobeforeafter]
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[fit,height fill, width=\linewidth, blank, borderline={0.5pt}{-2pt},halign=center, nobeforeafter]
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[fit,height=8.75cm, width=\textwidth, blank, borderline={0.5pt}{-2pt},halign=left, valign=center, nobeforeafter]
    \end{tcolorbox}
